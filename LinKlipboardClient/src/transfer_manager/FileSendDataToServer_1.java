...
public class FileSendDataToServer_1 extends Transfer {
	...
	public FileSendDataToServer_1(LinKlipboardClient client) {
		super();
		this.client = client;
		this.start();
	}
	...
	public void run() {
		...
		try {
			...
			// 도연 히스토리 테스트
			client.getHistory().addSharedContnestsInHistory(CommunicatingWithServer.getFileContents());
