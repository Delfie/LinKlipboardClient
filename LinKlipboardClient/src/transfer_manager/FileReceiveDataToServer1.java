...
public class FileReceiveDataToServer1 extends Thread {
	...
	public FileReceiveDataToServer1(LinKlipboardClient client) {
	}

	/** FileReceiveDataToServer 생성자 */
	public FileReceiveDataToServer1(LinKlipboardClient client, String fileName) {
		FileReceiveDataToServer1.receiveFilePath = LinKlipboard.fileReceiveDir + "\\" + fileName;
	}
